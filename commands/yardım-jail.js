...
exports.run = async (client, message, params) => {
  ...
  const embedyardim = new Discord.MessageEmbed()
    .setAuthor(" Taxperia   |   Hapishane Sistemi ")
    .setThumbnail(`https://cdn.discordapp.com/attachments/768490283770839080/842798834420547614/Taxperia1.png`)
    .setDescription("")
    .setColor(0x00ffff)
    .setDescription(
      `**<a:logo:751689078679797770>** **${prefix}jail-karantina-rol** Jaile atılan kişilerin alacağı rolü ayarlar. \n**<a:logo:751689078679797770>** **${prefix}jail-log** Jail sistemi için günlük kanalı ayarlar. \n**<a:logo:751689078679797770>** **${prefix}jail-yetkili-rol** Jail atacak yetkili rolünü ayarlar. \n**<a:logo:751689078679797770>** **${prefix}jail** Etiketlediğiniz kullanıcı cezalı duruma atar. \n\nNot: Eğer cezalıya attığınız kişilerin belirli kanalları görmesini istiyor iseniz cezalı rol olarak ayarladığınız role sunucu ayarlarından görmesini istediğiniz kanalalr için yetki verebilirsiniz. `
     )
      .addField(
        `__Bilgilendirme__`,
