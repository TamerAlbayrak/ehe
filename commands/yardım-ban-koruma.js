...
exports.run = async (client, message, params) => {
  ...
  .setAuthor(" Taxperia   |   Yasak Koruma Sistemi ")
    .setDescription("")
    .setColor(0x00ffff)
    .setThumbnail(`https://cdn.discordapp.com/attachments/768490283770839080/842798834420547614/Taxperia1.png`)
    .setDescription(
      `**<a:logo:751689078679797770>** **${prefix}ban-koruma** Ban koruma sistemini açar. \n**<a:logo:751689078679797770>** **${prefix}ban-koruma-sıfırla** Ban koruma sistemini sıfırlar.`
    )
