...
exports.run = async (client, message, params) => {
  ...
  const embedyardim = new Discord.MessageEmbed()
    .setAuthor(" Taxperia   |   Sunucudan Atma Sistemi ")
    .setThumbnail(`https://cdn.discordapp.com/attachments/768490283770839080/842798834420547614/Taxperia1.png`)
    .setDescription("")
    .setColor(0x00ffff)
    .setDescription(
      `**<a:logo:751689078679797770>** **${prefix}kick-log-ayarla** Kick sistemi için günlük kanalı ayarlar. \n**<a:logo:751689078679797770>** **${prefix}kick-yetkilisi-ayarla** Kick atabilecek yetkili rolü ayarlar. \n**<a:logo:751689078679797770>** **${prefix}kick** Etiketlediğin kullanıcıyı sunucudan atar. **<a:logo:751689078679797770>** **${prefix}kick-sistemi-kapat** Kick sistemini kapatır. `
     )
      .addField(
        `__Bilgilendirme__`,
