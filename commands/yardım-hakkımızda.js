...
exports.run = async (client, message, params) => {
  ...
  const embedyardim = new Discord.MessageEmbed()
    .setAuthor(" Taxperia   |   Hakkımızda ")
    .setThumbnail(`https://cdn.discordapp.com/attachments/768490283770839080/842798834420547614/Taxperia1.png`)
    .setDescription("")
    .setColor(0x00ffff)
    .setDescription(
`**<a:logo:751689078679797770>** **Taxperia nedir?** Taxperia sunucularınız için geliştirilen Türk yapımı koruma botudur. \n**<a:logo:751689078679797770>** **Bu bot sunucumu patlatır mı?** Hayır, botumuz sunucunuzu korumak için tasarlanmıştır. \n**<a:logo:751689078679797770>** **Siz kimsiniz?** Biz bu botun sahipleriyiz. Küçük bir ekibiz. Bizde sizler gibiyiz. Aramızda güçlü bir Arkadaşlık bağı Var. Yeri geldiğinde sohbet ederiz, oyun oynarız, dertleşiriz. Ama bizim tek amacımız sizleri her türlü kötü amaçlı olan kişilerden korumaktır. Bu zamana kadar discord uygulamasında insanalara yardım etmek için uğraştım ve hep uğraşacağım. `)
.addField(
    `__Bilgilendirme__`,
...
.setFooter("Taxperia Hakkımızda Komutları", client.user.avatarURL('https://cdn.discordapp.com/attachments/768490283770839080/842798834420547614/Taxperia1.png'));
