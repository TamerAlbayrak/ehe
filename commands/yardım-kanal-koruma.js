...
exports.run = async (client, message, params) => {
  ...
  const embedyardim = new Discord.MessageEmbed()
    .setAuthor(" Taxperia   |   Kanal Koruma Sistemi ")
    .setThumbnail(`https://cdn.discordapp.com/attachments/768490283770839080/842798834420547614/Taxperia1.png`)
    .setDescription("")
    .setColor(0x00ffff)
    .setDescription(
      `**<a:logo:751689078679797770>** **${prefix}kanal-koruma #logkanalı** Sunucudan kanal silen olusa silinen kanalı tekrar ekler ve loga bilgi düşer. \n**<a:logo:751689078679797770>** **${prefix}kanal-koruma-sıfırla** Kanal koruma sistemini kapatır.`
    )
    .addField(
      `__Bilgilendirme__`,
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ["channel-protection-system"],
  permLevel: 0
};
